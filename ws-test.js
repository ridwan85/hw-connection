...
function createPdf(values) {
  ...
  let divs = "";
  divs += `<div style="position:relative;margin:auto; padding-bottom: 25px; border-bottom: 1px dashed black;">
  <div style="/* display: flex; */">
  <img style="flex-direction: column;" alt="Kisok klangsentral" src="http://klangsentral.com/img/klangsentral-logo.png" height="90px" width="auto">
  <div style="text-align: center;flex-direction: column;font-weight: bold;align-self:center;">BUS TICKET<br></div>

</div>

<div class="btn" style="display:flex;flex-direction:row;justify-content: center;align-items: center;display: none;">
${tickectdetails.busticket}
</div>
